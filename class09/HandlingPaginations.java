...
public class HandlingPaginations {
    ...
    public static void main(String[] args) {
        ...
        boolean flag = true;
        while(flag) {
            List<WebElement> tableRows = driver.findElements(By.xpath("//table[@id = 'resultTable']tbody/tr"));// reinitialize all the elements
            //because the page gets refreshed after each next click
